...
if(!class_exists('THWDPF_Admin_Form_Cart_Rule')):

class THWDPF_Admin_Form_Cart_Rule extends THWDPF_Admin_Form{
	...
	private function render_form_tab_general_props(){
		...
		$args_from_dt = array(
			'label' => __('Start From','discount-and-dynamic-pricing'),
			'row_class' => 'form_field_startfrom',
		);
		$args_end_dt = array(
			'label' => __('End By','discount-and-dynamic-pricing'),
	...
	private function render_form_tab_restrictions(){
		...
		<div style="display: inherit;" class="data-panel-content mt-10">
			<table class="thwdpf_pp_table compact thwdpf-restrictions">
				...
				$this->render_form_fragment_h_separator();
				$this->render_form_fragment_h_spacing(10);
				?>
			</table>
			<table class="thwdpf_pp_table compact thwdpf-conditions">
				<?php
				$this->render_form_fragment_restrictions('product', 'thwdpf-restictions-cart');
				?>
			</table>
		</div>
		<?php
                                                        ...
                                                        <tr class="thwdpf_condition">
                                                            <td class="operand-type">
                                                                <select name="i_rule_operand_type">
	                                                                ...
	                                                                <option value="cart_subtotal"><?php esc_html_e('Cart Subtotal', 'discount-and-dynamic-pricing') ?></option>
                                                                </select>
                                                            </td>
                                                            <td class="operator">
